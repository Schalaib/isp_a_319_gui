...
l.pack(side=TOP)
e.pack()
bRED.pack(side=TOP,padx=5, pady=5)
bOrange.pack(side=TOP,padx=5, pady=5)
bBLUE.pack(side=TOP,padx=5, pady=5)
bYel.pack(side= TOP,padx=5, pady=5)
bGre.pack(side=TOP,padx=5, pady=5)
root.mainloop()